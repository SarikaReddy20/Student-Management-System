...
const StudentList = () => {
  ...
  const fetchStudents = async () => {
    try {
      const res = await axios.get('https://student-management-system-backend-k8zu.onrender.com/api/students');
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this student?')) {
      try {
        await axios.delete(`https://student-management-system-backend-k8zu.onrender.com/api/students/${id}`);
