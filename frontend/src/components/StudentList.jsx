...
const StudentList = () => {
  ...
  const fetchStudents = async () => {
    try {
      const res = await axios.get('https://studentmanagementsystem-backend-xfnw.onrender.com/api/students');
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this student?')) {
      try {
        await axios.delete(`https://studentmanagementsystem-backend-xfnw.onrender.com/api/students/${id}`);
