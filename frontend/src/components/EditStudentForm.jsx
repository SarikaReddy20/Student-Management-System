...
const EditStudentForm = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://student-management-system-backend-plie.onrender.com/api/students/${id}`)
      .then(res => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.put(`https://student-management-system-backend-plie.onrender.com/api/students/${id}`, student)
      .then(() => {
